...
dgp_fun2 = function(ind_totalID = 100, 
  ...
  ## non-parallel trend
  y_cf1 = c_intercept + 5 + alpha_noise_t + ifelse(time<=5, c_slope*time, c_slope*5 )+error
  ## diverging trend
...
a =dgp_fun2(ind_totalID = 100, 
            ...
            c_slope = 5,
            t_slope = 10)
b = a %>% pivot_longer(y_cf:y_cf2, names_to = "counter_factual", values_to = "y_cf")
...
ggplot() + 
  ...
  geom_jitter(data = b[b$treat==1 & b$counter_factual!="y_cf",], 
                aes(x= time, y = y_cf, color = counter_factual),alpha = 0.2, size = 1) +
  stat_summary(data = b[b$counter_factual!="y_cf",], 
  ...
  stat_summary(data = b[b$treat==0,], aes(x=time, y = y_c),color = "steelblue",fun=mean, geom="line", alpha = 1,size = 1)+
...
b = b %>% pivot_longer(y_t3:y_t4, names_to = "treated_outcome", values_to = "y_t.other")
ggplot() + 
  geom_jitter(data = b[b$treat==1,], 
              aes(x = time, y = y_t), color = "darkred", alpha = 0.2, size = 1)+
  stat_summary(data = b[b$treat==1,],
  ...
  stat_summary(data = b[b$treat==1,], aes(x=time, y = y_t.other, color = treated_outcome),
